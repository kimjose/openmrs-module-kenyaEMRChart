...
max(if(o.concept_id=162724,o.value_text,null)) as refill_facility,
...
121764, 164933, 160080, 1823, 164940, 164934, 164935, 159615, 160288,1855, 164947, 162724)
where e.voided=0 and e.date_created >= last_update_time
or e.date_changed >= last_update_time
or e.date_voided >= last_update_time
or o.date_created >= last_update_time
...
system_review_finding=VALUES(system_review_finding),refill_facility=VALUES(refill_facility), next_appointment_date=VALUES(next_appointment_date), next_appointment_reason=VALUES(next_appointment_reason), differentiated_care=VALUES(differentiated_care), voided=VALUES(voided)
;
