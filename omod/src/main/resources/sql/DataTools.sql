...
(case person_present when 978 then "Self (SF)" when 161642 then "Treatment supporter (TS)" when 159802 then "Refill visit documentation" when 5622 then "Other" else "" end) as person_present,
weight,
systolic_pressure,
diastolic_pressure,
height,
